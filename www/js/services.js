...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://easycake-b8e27.firebaseio.com/"),
    refCart = new Firebase("https://easycake-b8e27.firebaseio.com/cart"),
    refUser = new Firebase("https://easycake-b8e27.firebaseio.com/users"),
    refCategory = new Firebase("https://easycake-b8e27.firebaseio.com/category"),
    refOrder = new Firebase("https://easycake-b8e27.firebaseio.com/orders"),
    refFeatured = new Firebase("https://easycake-b8e27.firebaseio.com/featured"),
    refMenu = new Firebase("https://easycake-b8e27.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
