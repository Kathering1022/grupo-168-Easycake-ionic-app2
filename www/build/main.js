...
var map = {
	"../pages/bakery-orders/bakery-orders.module": [
		328,
		15
	],
	...
	"../pages/customer-order/customer-order.module": [
		333,
		12
	],
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_9_ionic_angular__["d" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_12__app_component__["a" /* MyApp */], {}, {
                    links: [
                        { loadChildren: '../pages/bakery-orders/bakery-orders.module#BakeryOrdersPageModule', name: 'BakeryOrdersPage', segment: 'bakery-orders', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/content/content.module#ContentPageModule', name: 'ContentPage', segment: 'content', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/cards/cards.module#CardsPageModule', name: 'CardsPage', segment: 'cards', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/home/home.module#HomePageModule', name: 'HomePage', segment: 'home', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/item-detail/item-detail.module#ItemDetailPageModule', name: 'ItemDetailPage', segment: 'item-detail', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/customer-order/customer-order.module#CustomerOrderPageModule', name: 'CustomerOrderPage', segment: 'customer-order', priority: 'low', defaultHistory: [] },
...
var MyApp = /** @class */ (function () {
    function MyApp(translate, platform, settings, config, statusBar, splashScreen) {
        ...
        this.pages = [
            ...
            { title: 'customer-order', component: 'CustomerOrderPage' }
        ];
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/gato_regex/grupo-168-Easycake-ionic-app2/easyCake/src/app/app.html"*/'<ion-menu [content]="content">\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>Pages</ion-title>\n      </ion-toolbar>\n    </ion-header>\n\n    <ion-content>\n      <ion-list>\n        <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n          {{p.title}}\n        </button>\n      </ion-list>\n    </ion-content>\n\n  </ion-menu>\n  <ion-nav #content [root]="rootPage"></ion-nav>'/*ion-inline-end:"/home/gato_regex/grupo-168-Easycake-ionic-app2/easyCake/src/app/app.html"*/
        }),
